...
/*   Updated: 2024/18/04 14:55:05 by keanders         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strcpy(char *dst, const char *src); // Copies string
size_t	ft_strncpy(char *dest, const char *src, size_t size); // Copies string with size
